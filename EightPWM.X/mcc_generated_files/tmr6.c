/**
  ...
  @Summary
    This is the generated driver implementation file for the TMR6 driver using MPLAB� Code Configurator
...
void TMR6_Initialize(void) {
    ...
    // T6CKPS 1:64; TMR6ON off; T6OUTPS 1:1; 
    T6CON = 0x60;

    // T6CS FOSC/4; 
    T6CLKCON = 0x00;

    // T6MODE Software control; T6PSYNC Not Synchronized; T6CKPOL Rising Edge; T6CKSYNC Not Synchronized; 
    T6HLT = 0x00;

    // T6RSEL TMR2_Postscaled; 
    T6RST = 0x05;
