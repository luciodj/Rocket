...
#define Potentiometer_OD                ODCONCbits.ODC0
...
#define Potentiometer_SetPushPull()    do { ODCONCbits.ODC0 = 1; } while(0)
#define Potentiometer_SetOpenDrain()   do { ODCONCbits.ODC0 = 0; } while(0)
